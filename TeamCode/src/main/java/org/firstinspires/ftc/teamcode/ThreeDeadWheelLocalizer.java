...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -6269.602399092636; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2371.8051424893556; // y position of the second parallel encoder (in tick units)
        public double perpXTicks =  -11261.74604046695; // x position of the perpendicular encoder (in tick units)
    }
